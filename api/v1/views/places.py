...
@swag_from('documetation/place/get_place.yml')  # Replace with your Swagger YAML file path
...
@swag_from('documetation/place/delete_place.yml')  # Replace with your Swagger YAML file path
...
@swag_from('documetation/place/create_place.yml')  # Replace with your Swagger YAML file path
...
#     """Get list of all Place objects in a City"""
#     city = storage.get(City, city_id)
#     if city is None:
#         abort(404)
#     places = [place.to_dict() for place in city.places]
